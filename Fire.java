...
public class Fire extends ElementalCharacter
{
	public final Image defaultImg1 = new ImageIcon(this.getClass().getResource("Default_Fire.png")).getImage();
	public final Image defaultImg2 = new ImageIcon(this.getClass().getResource("Default_Fire_Player2.png")).getImage();
	public final Image jump1 = new ImageIcon(this.getClass().getResource("Jump_Fire.png")).getImage();
	public final Image jump2 = new ImageIcon(this.getClass().getResource("Jump_Fire_Player2.png")).getImage();
	public final Image duck1 = new ImageIcon(this.getClass().getResource("Duck_Fire.png")).getImage();
	public final Image duck2 = new ImageIcon(this.getClass().getResource("Duck_Fire_Player2.png")).getImage();
	public final Image punchP11 = new ImageIcon(this.getClass().getResource("Punch1_Fire.png")).getImage();
	public final Image punchP12 = new ImageIcon(this.getClass().getResource("Punch2_Fire.png")).getImage();
	public final Image punchP21 = new ImageIcon(this.getClass().getResource("Punch1_Fire_Player2.png")).getImage();
	public final Image punchP22 = new ImageIcon(this.getClass().getResource("Punch2_Fire_Player2.png")).getImage();
	public final Image walkB1 = new ImageIcon(this.getClass().getResource("Walk1_Fire.png")).getImage();
	public final Image walkF1 = new ImageIcon(this.getClass().getResource("Walk2_Fire.png")).getImage();
	public final Image walkB2 = new ImageIcon(this.getClass().getResource("Walk1_Fire_Player2.png")).getImage();
	public final Image walkF2 = new ImageIcon(this.getClass().getResource("Walk2_Fire_Player2.png")).getImage();
	public final Image fall1 = new ImageIcon(this.getClass().getResource("Fall1_Fire.png")).getImage();
	public final Image fall1P2 = new ImageIcon(this.getClass().getResource("Fall1_Fire_Player2.png")).getImage();
	public final Image fall2 = new ImageIcon(this.getClass().getResource("Fall2_Fire.png")).getImage();
	public final Image fall2P2 = new ImageIcon(this.getClass().getResource("Fall2_Fire_Player2.png")).getImage();
	public final Image fall3 = new ImageIcon(this.getClass().getResource("Fall3_Fire.png")).getImage();
	public final Image fall3P2 = new ImageIcon(this.getClass().getResource("Fall3_Fire_Player2.png")).getImage();
	public final Image kick1 = new ImageIcon(this.getClass().getResource("Kick_Fire.png")).getImage();
	public final Image kick2 = new ImageIcon(this.getClass().getResource("Kick_Fire_Player2.png")).getImage();
	public final Image blast = new ImageIcon(this.getClass().getResource("Fire_Blast_Player1.png")).getImage();
	public final Image blast2 = new ImageIcon(this.getClass().getResource("Fire_Blast_Player2.png")).getImage();
     ...
     */
	public Fire(int xCoord, int yCoord,Image img,ElementalCharacter e, boolean orientationLeft)
	{		
...
//    }
    ...
    public ArrayList<Integer> ability1(Graphics g) 
    {
      	Graphics2D g2 = (Graphics2D) g;
      	...
      	for (int i = 1; i<=3; i++)
      	{
      		...
      		xCoords.add(temp);
      		g2.drawImage(new ImageIcon("fireSpikes.png").getImage(),temp,500,this);      		
      	}
      	return xCoords;
